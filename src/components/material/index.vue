                  ...
                  <el-dropdown v-if="data.id > 0" :hide-on-click="false">
                    ...
                    <template #dropdown>
                      <el-dropdown-menu>
                        ...
                        <div
                          @click="
                            handleDeleteCate(data.id, data?.children?.length)
                          "
                        >
      ...
      <div class="operate-btn flex">
        ...
        <div class="flex items-center ml-2">
          <el-tooltip content="列表视图" placement="top">
            ...
            >
              <baseIcon name="local-icon-list-2" :size="18" />
            </div>
          </el-tooltip>
          <el-tooltip content="平铺视图" placement="top">
            ...
            >
              <baseIcon name="el-icon-Menu" :size="18" />
            </div>
          </el-tooltip>
        </div>
      </div>
      ...
      <div class="material-center__content flex flex-col flex-1 mb-1 min-h-0">
              ...
              <del-wrap @close="batchFileDelete([item.id])">
                ...
                >
                  <div class="item-selected" v-if="isSelect(item.id)">
                    <baseIcon :size="24" name="el-icon-Check" color="#fff" />
                  </div>
                </file-item>
              </del-wrap>
        ...
        >
          ...
          <el-table-column label="图片" width="100">
            <template #default="{ row }">
              <file-item :uri="row.url" file-size="50px" :type="type" />
            </template>
          </el-table-column>
            ...
            <li class="mb-4" v-for="item in select" :key="item.id">
              <div class="select-item">
                <del-wrap @close="cancelSelete(item.id)">
                  <file-item :uri="item.url" file-size="100px" :type="type" />
                </del-wrap>
              </div>
            </li>
          </ul>
...
import { toRefs, computed, inject, ref, watch, onMounted } from "vue";
...
.material {
  ...
  &__left {
    @apply border-r flex flex-col w-[200px];
