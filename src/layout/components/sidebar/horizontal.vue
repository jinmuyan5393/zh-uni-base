...
const { title, logout, backTopMenu, onPanel, username, avatar, avatarsStyle, getDropdownItemStyle, getDropdownItemClass } = useNav();
        ...
        <template #dropdown>
          <el-dropdown-menu class="logout">
            <el-dropdown-item @click="logout">
              <BaseIcon name="el-icon-SwitchButton" />
