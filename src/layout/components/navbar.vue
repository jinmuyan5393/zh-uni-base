...
<template>
  <div class="navbar bg-[#fff] shadow-sm shadow-[rgba(0, 21, 41, 0.08)] dark:shadow-[#0d0d0d]">
    <topCollapse v-if="device === 'mobile'" class="hamburger-container" :is-active="appStore.sidebar.opened" @toggleClick="toggleSideBar" />
        ...
        <template #dropdown>
          <el-dropdown-menu class="logout">
            <el-dropdown-item @click="toUserinfo">
              <BaseIcon name="el-icon-User" style="margin: 5px" />
              {{ t("buttons.hsUserinfo") }}
            </el-dropdown-item>
            <el-dropdown-item @click="logout">
              <BaseIcon name="el-icon-SwitchButton" style="margin: 5px" />
