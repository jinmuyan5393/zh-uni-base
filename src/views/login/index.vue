...
<template>
  <div class="select-none">
    ...
    <!-- <component :is="toRaw(bg)" class="wave" /> -->
        ...
        <template #dropdown>
          <el-dropdown-menu class="translation">
            <el-dropdown-item
              ...
              @click="translationCh">
              <BaseIcon class="check-zh" v-show="locale === 'zh'" name="el-icon-Check" />
              简体中文
            </el-dropdown-item>
            <el-dropdown-item
      ...
      <div class="login-box">
        <div class="login-form">
          ...
          <el-form ref="ruleFormRef" :model="ruleForm" :rules="loginRules" size="large">
            <Motion :delay="100">
              <el-form-item :rules="[{ required: true, message: transformI18n($t('login.usernameReg')), trigger: 'blur' }]" prop="username">
                <el-input clearable v-model="ruleForm.username" :placeholder="t('login.username')" :prefix-icon="useRenderIcon('el-icon-User')" />
              </el-form-item>
            </Motion>
            ...
            <Motion :delay="150">
              <el-form-item prop="password" class="mt-2">
                <el-input
                  ...
                  :prefix-icon="useRenderIcon('el-icon-Lock')" />
              </el-form-item>
            </Motion>
