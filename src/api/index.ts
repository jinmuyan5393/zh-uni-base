...
// const baseURL = import.meta.env ? "/proxy" : import.meta.env.VITE_API_URL;
  ...
  public constructor(config: AxiosRequestConfig) {
    ...
    this.service.interceptors.request.use(
      (config: CustomAxiosRequestConfig) => {
        ...
        // 后端debugger
        // config.url = config.url + "?XDEBUG_SESSION=XDEBUG_ECLIPSE";
        return config;
      },
      (error: AxiosError) => {
...
export const uploadHttp = new RequestHttp(uploadConfig);
